...
export interface Vessel {id:string;name:string;mmsi?:string;latitude:number;longitude:number;speed?:number;course?:number;timestamp?:string;source?:string;provenance?:string;events?:any[];track?:any[];geographic_context?:string;replay?:boolean;original_timestamp?:string}
export interface Provider {id:string;name:string;status:string;records:number|null;provenance:string;detail?:string;last_refresh?:string;dataset?:string}
