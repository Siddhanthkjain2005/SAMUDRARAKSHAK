...
| Drift, route fuel, CO₂, assignment and risk | Backend numerical models and algorithms | Must remain `COMPUTED`; assumptions, units and uncertainty belong in the displayed explanation. |
